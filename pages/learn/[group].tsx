...
import { VideoCameraIcon, ViewGridAddIcon, DocumentIcon, BookOpenIcon, CodeIcon, AcademicCapIcon } from '@heroicons/react/outline';
...
const Learn = ({ resources, group }: LearnProps) => {
  ...
  return (
    <div className="text-center min-h-screen py-10 resource">
      <div className="max-w-4xl mx-auto pb-12">
        ...
        <h1 className=" font-bold text-6xl text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-yellow-500">Learn Event Driven Architecture</h1>
      ...
      <main className="bg-gray-900 min-h-screen py-14">
        ...
        <div className="py-10 max-w-5xl mx-auto grid grid-cols-2 gap-4">
          {resourcesToRender.map((resource: Resource, index) => {
            return <LearningMaterialItem key={index} resource={resource} />;
          })}
        </div>
      </main>
    </div>
